...
Router Address  : $(ip route show | grep -i 'default via'| awk '{print $3 }')
Router Name     : $(head -1 /etc/hosts | awk '{print $2}')
Network Address : $(tail -1  /etc/networks | awk '{print $2}')
Network Name    : $(tail -1  /etc/networks | awk '{print $1}')
EOF
